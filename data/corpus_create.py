...
def extract_text_from_html(html_path):
    ...
    try:
        with open(html_path, "r", encoding="utf-8") as file:
            ...
            # lines = [line.strip() for line in tamil_text.splitlines() if line.strip()]
            # cleaned_text = " ".join(lines)  # or "\n".join(lines) if you want line breaks
            tamil_text = re.sub(r"\n\s*\n+", "\n", tamil_text)
...
if __name__ == "__main__":
    html_directory = "./data/raw/"
    corpus_file = "./data/processed/tamil_corpus.txt"
